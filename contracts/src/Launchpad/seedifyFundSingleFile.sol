...
contract SeedifyFundsContract is Ownable {
    ...
    constructor(
        ...
        //   ,uint256 _tierFourValue, uint256 _tierFiveValue,uint256 _tierSixValue,
        //   uint256 _tierSevenValue,uint256 _tierEightValue ,uint256 _tierNineValue
        ...
        onlyOwner
    {
        ...
        // + tierFourMaxCap + tierFiveMaxCap + tierSixMaxCap
